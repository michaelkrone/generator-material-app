 ...
 */
var CrudController = require('./crud.controller.js');

function DummyController(model) {
...
DummyController.prototype = _.create(CrudController.prototype, DummyController.prototype);
...
var controller = new DummyController(dummyModel);
...
describe('crud controller', function () {
	...
	describe('GET', function () {
		...
		it('should respond with status 200 and an JSON array', function (done) {
			request(app)
				.get(apiRoute)
